...
Source0  : https://download.gnome.org/sources/gnome-calendar/46/gnome-calendar-46.1.tar.xz
...
%prep
%setup -q -n gnome-calendar-46.1
cd %{_builddir}/gnome-calendar-46.1
pushd ..
cp -a gnome-calendar-46.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713796585
