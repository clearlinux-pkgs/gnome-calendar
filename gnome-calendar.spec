...
Source0  : https://download.gnome.org/sources/gnome-calendar/3.36/gnome-calendar-3.36.2.tar.xz
...
%prep
%setup -q -n gnome-calendar-3.36.2
cd %{_builddir}/gnome-calendar-3.36.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595368081
...
cp %{_builddir}/gnome-calendar-3.36.2/COPYING %{buildroot}/usr/share/package-licenses/gnome-calendar/338650eb7a42dd9bc1f1c6961420f2633b24932d
