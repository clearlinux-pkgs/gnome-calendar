...
Requires: gnome-calendar-license
...
%prep
%setup -q -n gnome-calendar-3.30.0
...
%install
mkdir -p %{buildroot}/usr/share/doc/gnome-calendar
cp COPYING %{buildroot}/usr/share/doc/gnome-calendar/COPYING
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/gnome-calendar/COPYING
