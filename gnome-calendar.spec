...
Source0  : https://download.gnome.org/sources/gnome-calendar/42/gnome-calendar-42.0.tar.xz
...
%prep
%setup -q -n gnome-calendar-42.0
cd %{_builddir}/gnome-calendar-42.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647895809
...
cp %{_builddir}/gnome-calendar-42.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-calendar/338650eb7a42dd9bc1f1c6961420f2633b24932d
