...
Source0  : https://download.gnome.org/sources/gnome-calendar/43/gnome-calendar-43.1.tar.xz
...
%prep
%setup -q -n gnome-calendar-43.1
cd %{_builddir}/gnome-calendar-43.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666098490
