...
Source0  : https://download.gnome.org/sources/gnome-calendar/46/gnome-calendar-46.0.tar.xz
...
%prep
%setup -q -n gnome-calendar-46.0
cd %{_builddir}/gnome-calendar-46.0
pushd ..
cp -a gnome-calendar-46.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710891060
