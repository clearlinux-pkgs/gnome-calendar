...
%prep
%setup -q -n gnome-calendar-40.2
cd %{_builddir}/gnome-calendar-40.2
...
cp %{_builddir}/gnome-calendar-40.2/COPYING %{buildroot}/usr/share/package-licenses/gnome-calendar/338650eb7a42dd9bc1f1c6961420f2633b24932d
