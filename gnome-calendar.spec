...
Version  : 3.34.2
Release  : 34
URL      : https://download.gnome.org/sources/gnome-calendar/3.34/gnome-calendar-3.34.2.tar.xz
Source0  : https://download.gnome.org/sources/gnome-calendar/3.34/gnome-calendar-3.34.2.tar.xz
...
%prep
%setup -q -n gnome-calendar-3.34.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570653439
