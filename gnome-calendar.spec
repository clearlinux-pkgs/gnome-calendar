...
Source0  : https://download.gnome.org/sources/gnome-calendar/3.26/gnome-calendar-3.26.1.tar.xz
...
%prep
%setup -q -n gnome-calendar-3.26.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1506021069
export AR=gcc-ar
