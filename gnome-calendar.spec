...
Source0  : https://download.gnome.org/sources/gnome-calendar/41/gnome-calendar-41.2.tar.xz
...
%prep
%setup -q -n gnome-calendar-41.2
cd %{_builddir}/gnome-calendar-41.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639506654
...
cp %{_builddir}/gnome-calendar-41.2/COPYING %{buildroot}/usr/share/package-licenses/gnome-calendar/338650eb7a42dd9bc1f1c6961420f2633b24932d
