...
Version  : 3.26.0
Release  : 8
URL      : https://download.gnome.org/sources/gnome-calendar/3.26/gnome-calendar-3.26.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-calendar/3.26/gnome-calendar-3.26.0.tar.xz
...
%prep
%setup -q -n gnome-calendar-3.26.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1505316486
export AR=gcc-ar
