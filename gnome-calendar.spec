...
Version  : 3.24.0
Release  : 1
URL      : https://download.gnome.org/sources/gnome-calendar/3.24/gnome-calendar-3.24.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-calendar/3.24/gnome-calendar-3.24.0.tar.xz
...
%prep
%setup -q -n gnome-calendar-3.24.0

%build
export LANG=C
export SOURCE_DATE_EPOCH=1491772141
