...
Version  : 45.1
Release  : 85
URL      : https://download.gnome.org/sources/gnome-calendar/45/gnome-calendar-45.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-calendar/45/gnome-calendar-45.1.tar.xz
...
%prep
%setup -q -n gnome-calendar-45.1
cd %{_builddir}/gnome-calendar-45.1
pushd ..
cp -a gnome-calendar-45.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698071893
